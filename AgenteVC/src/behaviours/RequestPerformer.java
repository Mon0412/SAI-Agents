...
public class RequestPerformer extends Behaviour {
                ...
                if (reply != null) {
                    if (reply.getPerformative() == ACLMessage.INFORM) {
                        ...
                        JOptionPane.showMessageDialog(null,
                                bookTitle + " successfully purchased from agent " + reply.getSender().getName(), "Successfully!", JOptionPane.INFORMATION_MESSAGE);
    ...
    public boolean done() {
        if (step == 2 && bestSeller == null) {
            ...
            JOptionPane.showMessageDialog(null,
                    "Attempt failed: " + bookTitle + " not available for sale", "Sorry!", JOptionPane.ERROR_MESSAGE);                  
        }
